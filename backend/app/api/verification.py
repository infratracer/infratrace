...
from app.schemas.decision import ChainVerificationResult
...
@router.post("/projects/{project_id}/verify/blockchain")
async def verify_blockchain(
    ...
    if not decisions:
        return {"valid": True, "total_records": 0, "verified": 0, "message": "No records to verify"}
